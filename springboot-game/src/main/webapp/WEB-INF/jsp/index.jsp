                ...
                <div class="header-nav">
                    <div class="container-wapper">
                        <ul class="tanajil-clone-mobile-menu tanajil-nav main-menu " id="menu-main-menu">
                            <li class="menu-item  menu-item-has-children">
                                <a href="index.html" class="tanajil-menu-item-title" title="Home">Home</a>
                                <span class="toggle-submenu"></span>
                                <ul class="submenu">
                                    <li class="menu-item">
                            ...
                            <div class="slider-owl owl-slick equal-container nav-center"
                                ...
                                <div class="slider-item style9">
                                    <div class="slider-inner equal-element">
                                        <div class="slider-infor">
                                            <h5 class="title-small">
                                                Tanajil Best Collection
                                            </h5>
                                            <h3 class="title-big">
                                                The inspiration custom
                                            </h3>
                        ...
                        <div class="product-inner equal-element">
                            ...
                            <div class="product-thumb">
                                ...
                                <div class="product-count-down">
                                    <div class="tanajil-countdown" data-y="2020" data-m="10" data-w="4" data-d="10"
                    ...
                    <div class="product-item style-5">
                        <div class="product-inner equal-element">
                            ...
                            <div class="product-thumb">
                                ...
                                <div class="product-count-down">
                                    <div class="tanajil-countdown" data-y="2020" data-m="9" data-w="2" data-d="30"
                    ...
                    <div class="product-item style-5">
                        <div class="product-inner equal-element">
                            ...
                            <div class="product-thumb">
                                ...
                                <div class="product-count-down">
                                    <div class="tanajil-countdown" data-y="2020" data-m="12" data-w="1" data-d="24"
                    ...
                    <div class="product-item style-5">
                        <div class="product-inner equal-element">
                            ...
                            <div class="product-thumb">
                                ...
                                <div class="product-count-down">
                                    <div class="tanajil-countdown" data-y="2020" data-m="7" data-w="3" data-d="20"
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="banner">
                            <div class="item-banner style5">
                                <div class="inner">
                                    <div class="banner-content">
                                        <h3 class="title">Performance <br/>Parts</h3>
                                        <span class="code">
												Use code:
												<span>
													TANAJIL
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="coppyright">
                            Copyright © 2019
                            <a href="http://www.bootstrapmb.com/">Tanajil</a>
                            . All rights reserved
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
